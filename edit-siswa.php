                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="update-siswa.php" method="POST">
                            ...
                            <div class="form-group">
                                <label>Kota</label>
                                <input class="form-control" name="kota" placeholder="Masukkan Kota Siswa" rows="4" value="<?php echo $row['kota'] ?>"></input>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" name="tgl_lahir" value="<?php echo $row['tgl_lahir'] ?>"></input>
                            </div>
